...
if __name__ == "__main__":
    ...
    if args.dataset in ['dailydialog_wseq', 'dailydialog_hred', 'dailydialog_recosa']:
        sample_num = 300
    else:
        sample_num = 100
    ...
    # show(h1, h2, h3, bert_scores, "BERTScore", 'fluency')
    # show(h1, h2, h3, bert_scores, 'BERTScore', 'coherence')
    # show(h1, h2, h3, bert_scores, 'BERTScore', 'safety')
    # show(h1, h2, h3, bert_scores, 'BERTScore', 'overall')
